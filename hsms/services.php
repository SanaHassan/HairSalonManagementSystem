...
<html lang="en">
  <head>
    <title>SH Hair Salon | Services</title>
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/services1.jpeg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-pricing">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p>Our elite class services that we provide to our faithful customers</p>
          </div>
        </div>
