...
<html>
<head>
<title>SH Hair Salon | Manage Services</title>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="jumbotron">
					<div class="container">
						<h1 style="color:#5dc1bd; font-size: 36px;">Manage Services</h1>
						<p>A list of services that we offer at SH Hair Salon to our prestigious clients. </p>
