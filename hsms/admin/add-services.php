...
<body class="cbp-spmenu-push">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="jumbotron">
					<div class="container">
						<h1 style="color:#5dc1bd; font-size: 36px;">Add Services</h1>
						<p>Fill in the details below to add existing and upcoming services to expand the business. </p>
						<p><a class="btn btn-primary btn-md" href="../services.php" role="button">Learn more &raquo;</a></p>
					</div>
				</div>
				<div class="forms">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Name</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Service Name" value="" required="true"> </div> <div class="form-group"> <label for="exampleInputPassword1">Cost</label> <input type="text" id="cost" name="cost" class="form-control" placeholder="Cost" value="" required="true"> </div>
							  ...
							  <button type="submit" name="submit" class="btn btn-success btn-lg" style="margin-left: 90%;">Add</button> </form> 
						</div>
