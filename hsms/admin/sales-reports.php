...
<html>
<head>
<title>SH Hair Salon |  Sales Reports</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							...
							<div class="form-group">
							  <label for="exampleInputPassword1">Request Type</label><br><br>
							  <input type="radio" name="requesttype" value="mtwise" checked="true">Month wise<br><br>
                  			 <input type="radio" name="requesttype" value="yrwise">Year wise 
                  			</div>
							 
							
							
							  <button type="submit" name="submit" class="btn btn-success btn-lg" style="margin-left: 90%;">Submit</button> </form> 
						</div>
