...
<html>
<head>
<title>SH Hair Salon | Add Services</title>
...
<body class="cbp-spmenu-push">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="jumbotron">
					<div class="container">
						<h1 style="color:#5dc1bd; font-size: 36px; margin-top: 5%;">Add Employees</h1>
					</div>
				</div>
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Parlour Employees:</h4>
						</div>
						<div class="form-body">
							<form method="post">
    ...
    echo $msg;
               ...
               <div class="form-group"> <label for="exampleInputEmail1">Mobile Number</label> <input type="text" class="form-control" id="mobilenum" name="mobilenum" placeholder="Mobile Number" value="" required="true" maxlength="11" pattern="[0-9]+"> </div>
              <!--  <div class="radio">
                ...
                <div class="form-group"> <label for="AppointedDate">Appointed at Date</label> <textarea type="date" class="form-control" id="AppointedDate" name="AppointedDate" placeholder="Appointed at date" required="true" ></textarea> </div>
                <div class="form-group"> <label for="AppointedAs">Appointed as </label> <textarea type="text" class="form-control" id="AppointedAs" name="AppointedAs" placeholder="Appointed as a" required="true" ></textarea> </div>
