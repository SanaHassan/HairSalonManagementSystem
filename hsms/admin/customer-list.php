...
<html>
<head>
<title>SH Hair Salon | Customer List</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4>Customer List:</h4>
						<table class="table table-bordered"> <thead style="background-color: #f2b33f;"> <tr> <th>#</th> <th>Name</th> <th>Mobile</th> <th>Creation Date</th><th>Action</th> </tr> </thead> <tbody>
<?php
